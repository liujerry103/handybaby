...
function CRC16_CCITT(charach){
	...
	var i=0, k=0;
  //var crcout = new Uint8Array();
  //crcout[0] = 0xf8; crcout[1] = 0xa8;
  ...
  return stringtoutf(crc.toString(16));
	//crc &= 0xffff;
	//return crc.toString(16);
  //return stringtoutf(crc.toString(16))
  //crcout = stringtoutf(crc.toString(16));
  /*console.log(crc & 0xff);
  console.log((crc >> 8) & 0xff);
  console.log(crc.toString(16));
  crcout[1] = crc & (255);
  crcout[0] = (crc >> 8) & 0xff;*/
  //console.log("cc:"+ crcout);
